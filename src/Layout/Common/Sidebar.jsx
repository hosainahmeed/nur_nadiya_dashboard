...
import { SidebarRoutes } from "./sidebar-route/SidebarRoutes.jsx";
...
const SideBar = () => {
  ...
  return (
    <div className="flex bg-[var(--bg-pink-high)]/10 pt-3 flex-col h-full">
              ...
              <div key={item.key} className="mb-1">
                <Link
                  ...
                  className={`flex items-center px-4 py-3 text-base font-medium rounded-lg transition-all duration-200 ${
                    isActive
                      ? "bg-[var(--bg-pink-high)] text-white shadow-md"
                      : "text-black hover:bg-[var(--bg-pink-high)]/60 hover:text-white"
                  }`}
                  onClick={(e) => {
                    if (item.children) {
                      e.preventDefault();
